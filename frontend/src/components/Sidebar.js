        ...
        return `
            <div class="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
                ...
                <nav class="flex-1 p-4 space-y-1">
                    ...
                    <a href="#help" class="nav-link flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 text-gray-600 hover:text-gray-900 hover:bg-gray-50" data-route="help">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
